...
const NavBar = () => {
  return (
    <nav className="fixed w-full bg-gradient-to-b from-gray-800 via-gray-800/70 to-transparent z-50 pt-5 pb-7 sm:pt-8 sm:pb-10 text-sm sm:text-md">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto flex justify-between items-center">
          <a
            href="/"
            className="inline-block text-lg sm:text-xl font-light text-dark-accent transition-transform duration-200 hover:scale-105"
          >
            sbsepul
          </a>
